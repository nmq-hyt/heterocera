...
import com.example.heterocera.databinding.FragmentCameraBinding
import androidx.camera.lifecycle.ProcessCameraProvider
import androidx.core.content.ContextCompat
import androidx.navigation.NavController
import androidx.navigation.findNavController
import androidx.navigation.fragment.findNavController
import com.example.heterocera.CameraActivity
...
class CameraFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        cameraProviderFuture.addListener({
            ...
            fragmentCameraBinding.captureButton.setOnClickListener{
                navControl.navigate(R.id.action_cameraFragment_to_observationCaptureFragment)
            }

            fragmentCameraBinding.mapButton.setOnClickListener {
                navControl.navigate(R.id.action_cameraFragment_to_mapsActivity)
            }

            view.findViewById<ImageButton>(R.id.observations).setOnClickListener{
            ...
            view.findViewById<ImageButton>(R.id.search_button).setOnClickListener {
                navControl.navigate(R.id.action_cameraFragment_to_encyclopediaActivity)
            }
    ...
    inner class MothImageAnalyzer(context: Context) : ImageAnalysis.Analyzer {
        ...
        val items = mutableListOf<PredictedMoth>()
        ...
        override fun analyze(image: ImageProxy) {
            ...
            for (output in outputs) {
                Log.i(CameraActivity.TAG,output.label)
                highestLabel = output.label
                Log.i(CameraActivity.TAG, output.score.toString())
            }
            image.close()
        }
        ...
        private fun toBitmap(imageProxy: ImageProxy): Bitmap? {
            ...
            if (!::bitmapBuffer.isInitialized) {
                ...
                Log.d(CameraActivity.TAG, "Initalise toBitmap()")
    ...
    private fun takePhoto(navController: NavController) {
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults){
                    ...
                    val action = CameraFragmentDirections.actionCameraFragmentToObservationCaptureFragment(RecommendedLabel = highestLabel,
                        filename = name)
